...
function Accessibility() {
  ...
  const footerTemplate = getSiteContentTemplate('footer');
  const { content, heroImageUrl } = usePublicSiteContent('accessibility', template?.defaults || {});
  const { content: footerContent } = usePublicSiteContent('footer', footerTemplate?.defaults || {});
          ...
          <>
            ...
            <section className="page-content legal-copy" id="fair-housing">
              ...
              <article>
                ...
                <p>
                  <img className="eho-logo" src={footerContent.fairHousingImageUrl || '/equal-housing-opportunity.svg'} alt="Equal Housing Opportunity" width="200" />
                </p>
              </article>
            </section>
          </>
